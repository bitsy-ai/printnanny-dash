<template>
  <h3 class="text-lg font-bold text-gray-900 prose p-4">
    PrintNanny Build Information (<span class="font-mono">/etc/issue</span>)
  </h3>
  ...
  <h3 class="text-lg font-bold text-gray-900 prose p-4">
    PrintNanny CLI Version (<span class="font-mono">printnanny --version</span>)
  </h3>
