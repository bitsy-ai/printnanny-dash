...
<div class="flex w-full p-2">
    ...
    <Form @submit="submitStage1" v-else-if="formStage ==1" :validation-schema="formSchema1" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full md:w-1/2 mx-auto">
    ...
    <Form @submit="submitStage2" v-else-if="formStage ==2" :validation-schema="formSchema2" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full md:w-1/2 mx-auto">
        <h2 class="text-xl font-bold text-gray-900 prose mb-4">
          Connect Account
        </h2>
        <div class="mb-4">
        ...
        <Field name="email" disabled class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="email" type="text" :placeholder="formEmail" :value="formEmail" />
        </div>
        <div class="mb-4">
        <label class="block text-gray-700 text-sm font-bold mb-2" for="token">
            6-digit Code
        </label>
        <Field name="token" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="email" type="text" placeholder="Enter 6-digit code" />
