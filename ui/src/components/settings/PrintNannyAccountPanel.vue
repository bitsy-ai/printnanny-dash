...
<form class="divide-y divide-gray-200 lg:col-span-9" action="#" method="POST">
              ...
              <div class="py-6 px-4 sm:p-6 lg:pb-8">
                <div>
                  <h2 class="text-lg font-medium leading-6 text-gray-900">PrintNanny Cloud</h2>
                  <p class="mt-1 text-sm text-gray-500">Connect your PrintNanny Cloud account to get email alerts and monitor your 3D printer from anywhere.</p>
                </div>
                ...
                <div class="mt-6 flex flex-col lg:flex-row">
                  ...
                  <div class="mt-6 flex-grow lg:mt-0 lg:ml-6 lg:flex-shrink-0 lg:flex-grow-0">
                    <div class="mt-1 lg:hidden">
                      <div class="flex items-center">
                        <div class="inline-block h-12 w-12 flex-shrink-0 overflow-hidden rounded-full" aria-hidden="true">
                          <img class="h-full w-full rounded-full" src="@/assets/logos/printnanny/logo.svg" alt="PrintNanny" />
                        </div>
                    ...
                    <div class="relative hidden overflow-hidden rounded-full lg:block">
                      <img class="relative h-40 w-40 rounded-full" src="@/assets/logos/printnanny/logo.svg" alt="PrintNanny" />
                ...
                <div class="px-4 sm:px-6">
                  ...
                  <ul role="list" class="mt-2 divide-y divide-gray-200">
                    <SwitchGroup as="li" class="flex items-center justify-between py-4">
                      ...
                      <Switch v-model="availableToHire" :class="[availableToHire ? 'bg-indigo-500' : 'bg-gray-200', 'relative ml-4 inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2']">
                    ...
                    <SwitchGroup as="li" class="flex items-center justify-between py-4">
                      ...
                      <Switch v-model="privateAccount" :class="[privateAccount ? 'bg-indigo-500' : 'bg-gray-200', 'relative ml-4 inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2']">
                    ...
                    <SwitchGroup as="li" class="flex items-center justify-between py-4">
                      ...
                      <Switch v-model="allowCommenting" :class="[allowCommenting ? 'bg-indigo-500' : 'bg-gray-200', 'relative ml-4 inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2']">
                    ...
                    <SwitchGroup as="li" class="flex items-center justify-between py-4">
                      ...
                      <Switch v-model="allowMentions" :class="[allowMentions ? 'bg-indigo-500' : 'bg-gray-200', 'relative ml-4 inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2']">
