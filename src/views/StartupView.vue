<template>
    <div class="py-10">
      <header>
        <div class="flex grid grid-columns-1 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <transition name="slide-fade" appear :duration="800">

            <h1 class="flex text-3xl font-bold text-gray-800 prose text-center mx-auto">
              {{ pageTitle }}
            </h1>
          </transition>
          <h2
...
onMounted(async () => {
  ...
  const pageExtra =
    "You'll be redirected when PrintNanny is ready to use.";
  </script>
