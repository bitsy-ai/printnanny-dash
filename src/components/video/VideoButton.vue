  ...
  <div class="flex items-center">
    ...
    >
      ...
      <button
        ...
        v-if="store.videoRecordingButtonShowStart && store.videoRecordingButtonEnabled"
        class="ml-3 inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
      >
      ...
      <button
        ...
        v-else-if="!store.videoRecordingButtonShowStart && store.videoRecordingButtonEnabled"
        class="ml-3 inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
      >
        <PlayCircleIcon class="w-5 h-5 mr-2"></PlayCircleIcon>
        {{  store.videoRecordingButtonText }}
